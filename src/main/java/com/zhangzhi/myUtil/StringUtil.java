...
字符包起来。 
	...
	public static String tohtml(String rex) {
		
		String str =rex.replace(System.getProperty("line.separator"), "\r\n");
		String[] sp = str.split("\r\n");
		String newStr="";
		for(String str2:sp) {
			if(getPlaceHolderValue(str2,"\r")==null) {
				newStr+="<p>"+str2+"</p>";
			}else {
				String[] strr = str2.split("\r");
					newStr+="<p>"+strr[0]+"<br/></p>";
	...
	/*
	 * 功能：根据正则在字符创提取一段值，用于后面在rul地址里提取ID值
	 * 
	 */
